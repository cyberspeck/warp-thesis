...
%\input{thanks.tex}
\input{appendix.tex}
\addcontentsline{toc}{section}{Python Script}	% https://tex.stackexchange.com/questions/119719/add-an-item-in-the-table-of-contents
\includepdf[pages=-]{pdfs/FunITK.pdf}
\addcontentsline{toc}{section}{Generated data}
\addcontentsline{toc}{subsection}{rod \#5}
\includepdf[pages=-]{pdfs/rod_5.pdf}
\addcontentsline{toc}{subsection}{rod \#16}
