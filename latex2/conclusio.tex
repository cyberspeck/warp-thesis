...
A future distortion assessment of the whole FOV with 300 individual rods would profit from an effective procedure at low resolution.
...
This could be done by an auto-trace function which detects individual rods and applies the already implemented algorithms to each of them separately.\\
...
This does not rule out the possibility of using the MRI scanner for radiotherapy planning.
