...
Another possible explanation is that the imaged liquid separated into parts with different density earlier while the rod was stored upright.
...
At the same time, the computing time for calculations scale with the resolution of the images and should be kept minimal, because a future assessment would include more than 300 individual rods.
