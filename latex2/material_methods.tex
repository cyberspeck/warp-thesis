...
\caption{MR scanner coil: (1) upper part, Body/Spine Array Coil; (2,3) central positioning markers; (4) lower part, Body/Spine Array Coil; (5) connection ports; (6) colour label [image source: (with kind support of Siemens Healthineers)]}
\label{fig:coil}
\end{figure}
