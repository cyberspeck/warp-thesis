...
Alternatively, the DC for MRI can be calculated with the reference circle B placed in the COM of the corresponding CT image. (See chapter \ref{sec:discussion_DC} for a more thorough discussion.)
...
\begin{description}
 \item[1] simple: calculating the number of pixels based on rod size
 \item[2] iteration: finding a \texttt{COM} resulting in a good \texttt{DC}
\end{description}
