...
\begin{figure}[!h]
    ...
    \node [decision, below of=getDC, node distance=3cm] (bigger) {\textbf{4.} which one is bigger?};
    ...
    \node [decision, below of=next-guess, node distance=2.5cm] (repeat) {\textbf{7.} Repeat?};
