...
%    % Draw edges
	...
	\end{tikzpicture}
	\caption{Simple method to find \texttt{threshold} for \texttt{COM} calculation based on real rod size (inner diameter: $2\,mm$, outer diameter: $4\,mm$)}
...
\centering
  ...
  \end{subfigure}
  \caption{COM iteration method, 5 repetitions; red triangles correspond to upper guesses, blue dots to lower guesses}
