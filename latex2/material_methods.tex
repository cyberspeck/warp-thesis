...
\begin{enumerate}[label=\textbf{\arabic*)}]
 ...
 \item deformation (deviation from circular profile, dice-coefficient)
\end{enumerate}
...
If the lower percentage yields a better DC, the upper half of the range will be neglected in the next iteration, the new upper limit becomes the former guess ($50\%$).
If the higher percentage yields a better DC, the lower half of the range will be neglected in the next iteration, the new lower limit becomes the former guess ($50\%$).

Now, at the start of the second iteration, the range is smaller (half of the entire range) and the new guess will be set to be exactly in its middle.
