...
\begin{figure}[!tbp]
  ...
  \end{subfigure}
  \caption[Coronal images of 16 rods fileld with tested liquids.]{Coronal CT/MRI (inverted colours; same scale; cropped images) images of 16 rods (tested liquids, numbering starting from the right, \#6 excluded) + 2 reference rods (filled with water) on the sides.}
  \label{fig:coronal}
\end{figure}
...
395    & 212  & 0.1214  & -0.2454 & 0.2738 & 0.9815 & 0.9552 & 0.9089 & 0.1114  & -0.2424 & 0.2668 & 0.9921 & 0.9691 & 0.9311
 \end{tabular}
        \caption[Rod \#5: script generated data.]{rod \#5: script generated data; dist and $warp$ in [$mm$].}
...
\begin{figure}[!bth]
  ...
  \caption[Rod \#5: warp XY (iteration method), CT-MRI x100.]{Rod \#5: warp XY [$mm$] (iteration method), CT-MRI x100; plastic pane present from $-10mm$ to $10mm$, bubble at about $110mm$ to $135mm$.}
...
\end{tabular}
       \caption[Rod \#16: script generated data.]{rod \#5: script generated data; dist and $warp$ in [$mm$].}
