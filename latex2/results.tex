...
\bottomrule
\end{tabular}
\caption{Observations made in the first week regarding the mechanical properties of the tested solutions. Some rods contained bubbles which would move simply from buoyancy (when the rod was tilted or put upright), others required a knock to detach from the walls ('hit req.')}
\label{tab:bubbles1}
\end{table}
...
\bottomrule
\end{tabular}
\caption{Measured air accumulated in observed rods.}
\label{tab:bubbles2}
\end{table}
...
\begin{figure}[!tbh]
    ...
    \caption{Rod \#5: brightness of all pixels in each slice along z-axis, CT x100; the plastic pane fills the area from $-10mm$ to $10mm$.}
...
\begin{figure}[!tbh]
    ...
    \caption{Rod \#5: brightness of all pixels in each slice along z-axis, MRI x100; drop of max brightness at around $110mm$ to $135mm$ is due to air bubble.}
...
\begin{figure}[!thb]
    ...
    \caption{Rod \#16: brightness of all pixels in each slice along z-axis, CT x100}
...
\begin{figure}[!tbh]
    ...
    \caption{Rod \#16: brightness of all pixels in each slice along z-axis, MRI x100}
