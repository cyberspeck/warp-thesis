...
%\todo{The most important thing about CT is that it is super fast and that it does not introduce distortions. The disadvantages are the radiation dose and low soft tissue contrast}
...
%\todo{Add more? (Perfusion Spectroscopy, fMRI?)}
%https://www.youtube.com/watch?v=o6gqqeDfKGM

%Functional MRI (fMRI) is another ingenious imaging technique which enables doctors to 'watch the brain thinking'.
%It is based on the BOLD (Blood Oxygenation Level Dependent) effect, the fact that deoxygenated blood is paramagnetic and oxygenated blood diamagnetic.
%This means that deoxygenated blood looses its signal in the transverse plane quicker (low signal) than oxygenated blood (higer signal).
%MR signal than fully oxygenated blood
