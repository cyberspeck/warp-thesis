...
%\todo{The most important thing about CT is that it is superfast and that it does not introduce distortions. The dissadvantages are the radiation dose and low soft tissue contrast}
...
\todo{Write about other types of MRI - non morpholigic (diffusion weighted imaging, spectroscopy or contrast enhanced imaging}

\subsubsection{Image Quality}
\todo{include: soft tissue contrast is superior to CT, scan time is longer to get good SNR -> prone to movement artefacts, lower resolution results in better SNR -> trade-off, field imperfectness (inhomogeneities) result in distortion}

One drawback of MRI, and especially open bore scanners, is the occurring distortion due to inhomogeneities in the magnetic field.
...
\todo{incorporate following quote/source}
"The HPA (2008) [15.4] has summarised the literature on the effects of
