...
\footnotetext{source: by Materialscientist, CC BY-SA 3.0 (\url{https://creativecommons.org/licenses/by-sa/3.0}) or GFDL (\url{http://www.gnu.org/copyleft/fdl.html}), via Wikimedia Commons}
...
\begin{figure}[!h]
	...
	\caption{energy release of ionising radiation; source: by Cepheiden \cite{cepheiden}}
	\label{fig:bragg}
\end{figure}
